...
$_POST['user_name'] = $userdata['user_name'];
...
<td class='tbl'><input type='text' readonly name='user_name' value='".$userdata['user_name']."' maxlength='30' class='textbox' style='width:200px;'></td>
</tr>
<tr>
