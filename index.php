...
include "./home/mainconfig.php";
	$HTML = "";
$HTML .= "<title>$site_title: Agreement</title>";
	echo $HTML;
?>
...
<body text="#FFFFFF">
<center>
<div valign="top" style="width:100%; background:url(home/images/en_US/alliance-tile.jpg)" height="336">
...
<table class="tabelbasic1" cellspacing="0" cellpadding="15" width="100%" align="center" class="style5" style="font-size:20pt">
	<tr>
		<td>
			<textarea name="S1" rows="25" style="width:100%; color:#ffac04; border: 1px #777777 solid;" readonly="readonly">
			
<?php
include "./home/mainconfig.php";
	$HTML = "";
$HTML .= "Welcome to $site_title !";
	echo $HTML;
?>
...
if (FF.CB.checked)
{
FF.BB.src = home/images/en_US/decline.gif
}
else
{
FF.BB.src = home/images/en_US/agree.gif
}
}
</script>
-->
