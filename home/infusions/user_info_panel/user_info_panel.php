...
echo "<br /><center><img src='".BASEDIR."images/avatar_no.png'><br>[ no avatar ]</center><br />\n";
}
...
<img src='".THEME."images/bullet.gif' alt=''> <a href='".BASEDIR."members.php' class='side'>".$locale['082']."</a><br>\n";
	if (iADMIN && (iUSER_RIGHTS != "" || iUSER_RIGHTS != "C")) {
		echo "<img src='".THEME."images/bullet.gif' alt=''> <a href='".ADMIN."index.php".$aidlink."' class='side'><font color='brown'>".$locale['083']."</font></a><br>\n";
	}
