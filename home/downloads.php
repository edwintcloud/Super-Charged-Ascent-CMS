		...
		if (checkgroup($cdata['download_cat_access'])) {
			...
			if ($rows != 0) {
				...
				while ($data = dbarray($result)) {
					...
					echo "<td width='30%' class='tbl1'><b>".$locale['415']."</b> ".$data['download_count']."</td>\n<td width='40%' class='tbl2'><img src='".THEME."images/arrow-download.gif'> <a href='".FUSION_SELF."?cat_id=$cat_id&amp;download_id=".$data['download_id']."' target='_blank'>".$locale['416']."</a> (".$data['download_filesize'].")</td>\n</tr>\n";
					echo "</table>\n";
