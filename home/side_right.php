<?php
 ...
 $right_panels = true;
 if (is_array($theme_panels_exclude)) {
 for($i=0;$i<count($theme_panels_exclude);$i++) {
 if (eregi($theme_panels_exclude[$i], $current_script_path)) $right_panels = false;
 } 
 } 
  
 if ($right_panels == true) {
