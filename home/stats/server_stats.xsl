...
<xsl:template match="/">
	...
	<body>
		...
		<div class="footer">
			Original design by mmorpg4free.com, styling by NoriaC, rescripted by Red
		</div>
		</center>
	</body>
	</html>
...
<xsl:template match="status">
	...
	<form>
		...
		<input type="button" class="button" value="Go Back" onClick="window.location='../'" />
		<input type="button" class="button" value="Forum" onClick="window.location='../forum'" />
	</form>
	</div>
</xsl:template>
			...
			<td align="center">
				<xsl:choose>
					<xsl:when test="gender = 1">
						<xsl:choose>
							<xsl:when test="race = 1"><img src="icon/race/1-1.gif" alt="Human" /></xsl:when>
							<xsl:when test="race = 2"><img src="icon/race/2-1.gif" alt="Orc" /></xsl:when>
							<xsl:when test="race = 3"><img src="icon/race/3-1.gif" alt="Dwarf" /></xsl:when>
							<xsl:when test="race = 4"><img src="icon/race/4-1.gif" alt="Night Elf" /></xsl:when>
							<xsl:when test="race = 5"><img src="icon/race/5-1.gif" alt="Undead" /></xsl:when>
							<xsl:when test="race = 6"><img src="icon/race/6-1.gif" alt="Tauren" /></xsl:when>
							<xsl:when test="race = 7"><img src="icon/race/7-1.gif" alt="Gnome" /></xsl:when>
							<xsl:when test="race = 8"><img src="icon/race/8-1.gif" alt="Troll" /></xsl:when>
							<xsl:when test="race = 10"><img src="icon/race/10-1.gif" alt="Blood Elf" /></xsl:when>
							<xsl:when test="race = 11"><img src="icon/race/11-1.gif" alt="Draenei" /></xsl:when>
						</xsl:choose>
					</xsl:when>
					<xsl:otherwise>
						<xsl:choose>
...
<xsl:template match="sessions">
	<table width="100%" border="0" cellspacing="1" cellpadding="2">
		...
		<tr>
			...
			<td align="center">
				<xsl:choose>
					<xsl:when test="pvprank = 1"><img src="icon/pvpranks/rank1.gif" alt="Private - Scout" /></xsl:when>
					<xsl:when test="pvprank = 2"><img src="icon/pvpranks/rank2.gif" alt="Corporal - Grunt" /></xsl:when>
					<xsl:when test="pvprank = 3"><img src="icon/pvpranks/rank3.gif" alt="Sergeant - Sergeant" /></xsl:when>
					<xsl:when test="pvprank = 4"><img src="icon/pvpranks/rank4.gif" alt="Master Sergeant - Senior Sergeant" /></xsl:when>
					<xsl:when test="pvprank = 5"><img src="icon/pvpranks/rank5.gif" alt="Sergeant Major - First Sergeant" /></xsl:when>
					<xsl:when test="pvprank = 6"><img src="icon/pvpranks/rank6.gif" alt="Knight - Stone Guard" /></xsl:when>
					<xsl:when test="pvprank = 7"><img src="icon/pvpranks/rank7.gif" alt="Knight-Lieutenant - Blood Guard" /></xsl:when>
					<xsl:when test="pvprank = 8"><img src="icon/pvpranks/rank8.gif" alt="Knight-Captain - Legionnaire" /></xsl:when>
					<xsl:when test="pvprank = 9"><img src="icon/pvpranks/rank9.gif" alt="Knight-Champion - Centurion" /></xsl:when>
					<xsl:when test="pvprank = 10"><img src="icon/pvpranks/rank10.gif" alt="Lieutenant - Commander Champion" /></xsl:when>
					<xsl:when test="pvprank = 11"><img src="icon/pvpranks/rank11.gif" alt="Commander Lieutenant - General" /></xsl:when>
					<xsl:when test="pvprank = 12"><img src="icon/pvpranks/rank12.gif" alt="Marshal - General" /></xsl:when>
					<xsl:when test="pvprank = 13"><img src="icon/pvpranks/rank13.gif" alt="Field Marshal - Warlord" /></xsl:when>
					<xsl:when test="pvprank = 14"><img src="icon/pvpranks/rank14.gif" alt="Grand Marshal - High Warlord" /></xsl:when>
					<xsl:when test="pvprank = 15"><img src="icon/pvpranks/rank15.gif" alt="??" /></xsl:when>
					<xsl:otherwise>
						<xsl:choose>
