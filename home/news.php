	...
	if ($rows != 0) {
		...
		while ($data = dbarray($result)) {
			...
			if ($data['news_cat_image']) {
				$news_cat_image = "<img src='".IMAGES_NC.$data['news_cat_image']."' alt='".$data['news_cat_name']."' align='left' style='border:0px;margin-top:3px;margin-right:5px'></a>";
			} else {
				$news_cat_image = "";
			}
