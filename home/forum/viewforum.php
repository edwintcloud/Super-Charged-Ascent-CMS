...
if (iMEMBER && $can_post) {
	echo "<td align='right' class='tbl6'>
...
<tr>
<td width='20' class='tbl5'><img src='".THEME."forum/flag.gif'></td>
<td class='tbl5'>".$locale['451']."</td>
<td width='100' class='tbl5'>".$locale['452']."</td>
<td align='center' width='50' class='tbl5'>".$locale['453']."</td>
<td align='center' width='50' class='tbl5'>".$locale['454']."</td>
<td width='120' class='tbl5'>".$locale['404']."</td>
</tr>\n";
	...
	if (dbrows($result) != 0) {
		while ($data = dbarray($result)) {
			if ($data['thread_locked']) {
				echo "<tr>\n<td align='center' width='25' class='tbl2'><img src='".THEME."forum/folderlock.png' alt='".$locale['564']."'></td>";
			} else  {
