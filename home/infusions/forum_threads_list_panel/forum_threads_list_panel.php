...
if (dbrows($result) != 0) {
	...
	if ($theme_width == "100%") echo "<td class='tbl4'><span class='small'><b>".$locale['030']."</b></span></td>\n";
	echo "<td class='tbl4'><span class='small'><b>".$locale['031']."</b></span></td>
<td align='center' width='1%' class='tbl4' style='white-space:nowrap'><span class='small'><b>".$locale['033']."</b></span></td>
<td align='center' colspan='2' width='1%' class='tbl4' style='white-space:nowrap'><span class='small'><b>".$locale['034']."</b></span></td>
</tr>\n";
	while ($data = dbarray($result)) {
		if ($i % 2 == 0) { $row_color = "tbl1"; } else { $row_color = "tbl2"; }
		echo "<tr>\n";
		if ($theme_width == "100%") {
			echo "<td width='45%' class='$row_color'><span class='small'><img src='".THEME."images/bullet.gif'> ".$data['forum_name']."</span></td>
...
<td align='center' width='1%' class='$row_color' style='white-space:nowrap'><span class='small'>".showdate("forumdate", $data['thread_lastpost'])."</span></td>
	...
	if (iMEMBER) {
		echo "<tr>\n<td align='center' colspan='5' class='tbl6'><span class='small'><a href='".INFUSIONS."forum_threads_list_panel/my_threads.php'>".$locale['026']."</a> |
