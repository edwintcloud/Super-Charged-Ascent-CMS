...
<tr>
<td class='tbl4'><b>".$data['user_name']."</b></td>
<td align='right' class='tbl4'>".getuserlevel($data['user_level'])."</td>
</tr>
</table>
</td>
<tr>
...
<td width='1%' class='tbl1' style='white-space:nowrap'><b><img src='".BASEDIR."images/profile/location.png'> ".$locale['u009']."</b></td>
...
<tr>
<td width='1%' class='tbl1' style='white-space:nowrap'><b><img src='".BASEDIR."images/profile/im_aim.gif'> ".$locale['u021']."</b></td>
<td class='tbl1'>".($data['user_aim'] ? $data['user_aim'] : $locale['u048'])."</td>
</tr>
<tr>
<td width='1%' class='tbl2' style='white-space:nowrap'><b><img src='".BASEDIR."images/profile/im_icq.gif'> ".$locale['u011']."</b></td>
<td class='tbl2'>".($data['user_icq'] ? $data['user_icq'] : $locale['u048'])."</td>
</tr>
<tr>
<td width='1%' class='tbl1' style='white-space:nowrap'><b><img src='".BASEDIR."images/profile/im_msn.gif'> ".$locale['u012']."</b></td>
...
<td align='center' class='tbl1'>\n";
	...
	echo "</td>
<td width='1%' class='tbl2' style='white-space:nowrap'><b><img src='".BASEDIR."images/profile/im_yahoo.gif'> ".$locale['u013']."</b></td>
<td class='tbl2'>".($data['user_yahoo'] ? $data['user_yahoo'] : $locale['u048'])."</td>
	...
	echo "<table align='center' cellpadding='0' cellspacing='1' width='400' class='tbl-border'>
<tr>
<td class='tbl4' colspan='2'><b>".$locale['422']."</b></td>
</tr>
<tr>
...
<td class='tbl1'>".number_format($data['user_posts'])."</td>
	...
	if ($data['user_groups']) {
		tablebreak();
		echo "<table align='center' cellpadding='0' cellspacing='1' width='400' class='tbl-border'>\n";
		echo "<tr>\n<td class='tbl4'><b>".$locale['423']."</b></td>\n\n</tr>\n<tr>\n<td class='tbl1'>\n";
...
<tr>
<td align='center' colspan='2' class='tbl4'><b>".$data['group_name']."</b> (".sprintf((dbrows($result)==1?$locale['411']:$locale['412']), dbrows($result)).")</td>
</tr>
<tr>
<td class='tbl6'><b>".$locale['401']."</b></td>
<td align='center' width='1%' class='tbl6' style='white-space:nowrap'><b>".$locale['402']."</b></td>
</tr>\n";
